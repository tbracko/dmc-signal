...
const COINS = {
  ...
  crude:       { id:'crude',       label:'CRUDE',  apiSym:'xyz:CL',     asset:'xyz:CL',     exchange:'hyperliquid', minRR: 1.2, feeEst: 0.12, minStopPct: 0.005, equityPct: 2.40, cooldownMin: 45, isHIP3: true,  breakDistFloorPct: 0.0008, minBreakCloses: 1, closeExitR: 0.5 }, // v5.44 (2026-07-10): 1.20→2.40 — CONVICTION BUMP (half-step toward core). Crude cleared validation: 90d 37 closed RTs, 59.5% win, PF 1.38, +$11.52, expectancy +$0.31/trade. 2.40 × minStop 0.5% = 1.2% risk (core is 3%); deliberately kept below core since PF/expectancy are real but thin. // closeExitR 0.5 (matches SP500): structure close-exit for the squeeze failure mode; losers are short counter-squeezes ~1.5%.
